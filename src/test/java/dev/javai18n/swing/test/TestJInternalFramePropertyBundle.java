...
/**
 * Unit tests for JInternalFramePropertyBundle.
 */
public class TestJInternalFramePropertyBundle
{
    /**
    ...
    {
        JInternalFramePropertyBundle bundle = new JInternalFramePropertyBundle();
        bundle.setAttribute(JInternalFramePropertyBundle.TITLE, "My Internal Frame");
