...
/**
 * Unit tests for ResourcefulJScrollPane.
 */
public class TestResourcefulJScrollPane
{
    ...
    public void testLocaleChange()
    {
        ...
        assertEquals("TestScrollPane nom", scrollPane.getName());
        assertEquals("Info-bulle volet de défilement test", scrollPane.getToolTipText());
    }
}
