 ...
 */
public class ResourcefulJTextField extends JTextField implements Resourceful, LocaleEventListener
{
     ...
     *                 JTextField.
     * @return A ResourcefulJTextField with updated Locale-specific values that is registered to listen to LocaleEvents
     *         generated from the specified Resource's source.
     */
    public static ResourcefulJTextField create(Resource resource)
    {
        ResourcefulJTextField textField = new ResourcefulJTextField(resource);
     ...
     *                 JTextField.
     */
    protected ResourcefulJTextField(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.text.field", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JTextField.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JTextField.
     */
    @Override
