...
/**
 * Unit tests for ResourcefulJRadioButtonMenuItem.
 */
public class TestResourcefulJRadioButtonMenuItem
{
    ...
    public void testInitialProperties()
    {
        ...
        assertEquals("Test radio menu item tooltip", menuItem.getToolTipText());
    }
