...
/**
 * Unit tests for ResourcefulJPanel.
 */
public class TestResourcefulJPanel
{
    ...
    public void testLocaleChange()
    {
        ...
        assertEquals("TestPanel nom", panel.getName());
        assertEquals("Info-bulle panneau test", panel.getToolTipText());
    }
}
