 ...
 */
public class ResourcefulJToolBar extends JToolBar implements Resourceful, LocaleEventListener
{
     ...
     *                 JToolBar.
     * @return A ResourcefulJToolBar with updated Locale-specific values that is registered to listen to LocaleEvents
     *         generated from the specified Resource's source.
     */
    public static ResourcefulJToolBar create(Resource resource)
    {
        ResourcefulJToolBar toolBar = new ResourcefulJToolBar(resource);
        toolBar.initialize();
        return toolBar;
    }
     ...
     *                 JToolBar.
     */
    protected ResourcefulJToolBar(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.tool.bar", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JToolBar.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JToolBar.
     */
    @Override
