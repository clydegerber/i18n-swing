...
/**
 * Unit tests for ResourcefulJLabel.
 */
public class TestResourcefulJLabel
{
    ...
    public void testLocaleChange()
    {
        ...
        assertEquals("Libellé Test", label.getText());
        assertEquals("Info-bulle libellé test", label.getToolTipText());
    }
}
