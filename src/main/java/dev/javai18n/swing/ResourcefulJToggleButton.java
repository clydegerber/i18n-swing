...
/**
 * A JToggleButton that supports localizing the name, tool tip, font, text, mnemonic, accessible name, accessible
 * description and icons (normal, pressed, selected, disabled, disabled selected, rollover and rollover selected).
 */
public class ResourcefulJToggleButton extends JToggleButton implements Resourceful, LocaleEventListener
{
     ...
     *                 JToggleButton.
     * @return A ResourcefulJToggleButton with updated Locale-specific values that is registered to listen to
     *         LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulJToggleButton create(Resource resource)
    {
        ResourcefulJToggleButton button = new ResourcefulJToggleButton(resource);
        button.initialize();
        return button;
    }
     ...
     *                 JToggleButton.
     */
    protected ResourcefulJToggleButton(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.toggle.button", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JToggleButton.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JToggleButton.
     */
    @Override
