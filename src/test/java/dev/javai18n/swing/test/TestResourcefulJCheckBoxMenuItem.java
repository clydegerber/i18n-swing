...
/**
 * Unit tests for ResourcefulJCheckBoxMenuItem.
 */
public class TestResourcefulJCheckBoxMenuItem
{
    ...
    public void testInitialProperties()
    {
        ...
        assertEquals("Test checkbox menu item tooltip", menuItem.getToolTipText());
    }
    ...
    public void testLocaleChange()
    {
        ...
        assertEquals("Case Menu Test", menuItem.getText());
        assertEquals("Info-bulle case menu test", menuItem.getToolTipText());
    }
}
