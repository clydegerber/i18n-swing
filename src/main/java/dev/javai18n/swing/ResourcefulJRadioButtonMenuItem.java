...
/**
 * A JRadioButtonMenuItem that supports localizing the name, tool tip, font, text, mnemonic, accessible name,
 * accessible description and icons (normal, pressed, selected, disabled, disabled selected, rollover and rollover
 * selected).
 */
public class ResourcefulJRadioButtonMenuItem extends JRadioButtonMenuItem implements Resourceful, LocaleEventListener
{
     ...
     * @return A ResourcefulJRadioButtonMenuItem with updated Locale-specific values that is registered to listen to
     *         LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulJRadioButtonMenuItem create(Resource resource)
    {
        ResourcefulJRadioButtonMenuItem menuItem = new ResourcefulJRadioButtonMenuItem(resource);
        menuItem.initialize();
        return menuItem;
    }
    ...
    /**
     * Construct a ResourcefulJRadioButtonMenuItem with the specified Resource containing localized values for the
     * JRadioButtonMenuItem.
     * @param resource A Resource containing an AbstractButtonPropertyBundle that holds the localized values for the
     *                 JRadioButtonMenuItem.
     */
    protected ResourcefulJRadioButtonMenuItem(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.radio.button.menu.item", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JRadioButtonMenuItem.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JRadioButtonMenuItem.
     */
    @Override
