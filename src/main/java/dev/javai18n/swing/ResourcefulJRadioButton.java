...
/**
 * A JRadioButton that supports localizing the name, tool tip, font, text, mnemonic, accessible name, accessible
 * description and icons (normal, pressed, selected, disabled, disabled selected, rollover and rollover selected).
 */
public class ResourcefulJRadioButton extends JRadioButton implements Resourceful, LocaleEventListener
{
     ...
     *                 JRadioButton.
     * @return A ResourcefulJRadioButton with updated Locale-specific values that is registered to listen to
     *         LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulJRadioButton create(Resource resource)
    {
        ResourcefulJRadioButton button = new ResourcefulJRadioButton(resource);
        button.initialize();
        return button;
    }
     ...
     *                 JRadioButton.
     */
    protected ResourcefulJRadioButton(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.radio.button", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JRadioButton.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JRadioButton.
     */
    @Override
