...
/**
 * A JCheckBoxMenuItem that supports localizing the name, tool tip, font, text, mnemonic, accessible name, accessible
 * description and icons (normal, pressed, selected, disabled, disabled selected, rollover and rollover selected).
 */
public class ResourcefulJCheckBoxMenuItem extends JCheckBoxMenuItem implements Resourceful, LocaleEventListener
{
     ...
     *                 JCheckBoxMenuItem.
     * @return A ResourcefulJCheckBoxMenuItem with updated Locale-specific values that is registered to listen to
     *         LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulJCheckBoxMenuItem create(Resource resource)
    {
        ResourcefulJCheckBoxMenuItem menuItem = new ResourcefulJCheckBoxMenuItem(resource);
        menuItem.initialize();
        return menuItem;
    }
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.check.box.menu.item", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JCheckBoxMenuItem.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JCheckBoxMenuItem.
     */
    @Override
