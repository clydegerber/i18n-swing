 ...
 */
public class ResourcefulJTextArea extends JTextArea implements Resourceful, LocaleEventListener
{
     ...
     *                 JTextArea.
     * @return A ResourcefulJTextArea with updated Locale-specific values that is registered to listen to LocaleEvents
     *         generated from the specified Resource's source.
     */
    public static ResourcefulJTextArea create(Resource resource)
    {
        ResourcefulJTextArea textArea = new ResourcefulJTextArea(resource);
        textArea.initialize();
        return textArea;
    }
     ...
     *                 JTextArea.
     */
    protected ResourcefulJTextArea(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.text.area", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JTextArea.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JTextArea.
     */
    @Override
