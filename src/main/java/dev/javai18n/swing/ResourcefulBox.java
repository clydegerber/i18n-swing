...
/**
 * A {@link Box} that participates in locale change events, updating its accessible metadata,
 * font, and name whenever the application locale changes.
 *
 * <p>Use {@link BoxLayout#X_AXIS} or {@link BoxLayout#Y_AXIS} (and the line/page equivalents)
 * as the {@code axis} argument to the factory methods.</p>
 */
public class ResourcefulBox extends Box implements Resourceful, LocaleEventListener
{
     ...
     * @return A ResourcefulBox registered to listen to LocaleEvents from the resource's source.
     */
    public static ResourcefulBox create(Resource resource, int axis)
    {
        ResourcefulBox box = new ResourcefulBox(resource, axis);
        box.initialize();
        return box;
    }
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.box", ex);
        }
    }
