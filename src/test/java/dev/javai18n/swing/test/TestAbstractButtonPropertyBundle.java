...
public class TestAbstractButtonPropertyBundle
{
    ...
    {
        AbstractButtonPropertyBundle bundle = new AbstractButtonPropertyBundle();
        bundle.setAttribute(AbstractButtonPropertyBundle.ICON, "/dev/javai18n/swing/test/MN_Flag.jpg");
        assertEquals(1, bundle.size());
        assertEquals(true, bundle.containsKey(AbstractButtonPropertyBundle.ICON));
        Icon icon = bundle.getIcon();
        assertNotNull(icon);
        bundle.setAttribute(AbstractButtonPropertyBundle.DISABLED_ICON, "/dev/javai18n/swing/test/MN_Flag.jpg");
        assertEquals(2, bundle.size());
        assertEquals(true, bundle.containsKey(AbstractButtonPropertyBundle.DISABLED_ICON));
        icon = bundle.getDisabledIcon();
        assertNotNull(icon);
        bundle.setAttribute(AbstractButtonPropertyBundle.DISABLED_SELECTED_ICON, "/dev/javai18n/swing/test/MN_Flag.jpg");
        ...
        assertNotNull(icon);
        bundle.setAttribute(AbstractButtonPropertyBundle.ROLLOVER_ICON, "/dev/javai18n/swing/test/MN_Flag.jpg");
        assertEquals(4, bundle.size());
        assertEquals(true, bundle.containsKey(AbstractButtonPropertyBundle.ROLLOVER_ICON));
        icon = bundle.getRolloverIcon();
        assertNotNull(icon);
        bundle.setAttribute(AbstractButtonPropertyBundle.ROLLOVER_SELECTED_ICON, "/dev/javai18n/swing/test/MN_Flag.jpg");
        ...
        assertNotNull(icon);
        bundle.setAttribute(AbstractButtonPropertyBundle.PRESSED_ICON, "/dev/javai18n/swing/test/MN_Flag.jpg");
        ...
        assertNotNull(icon);
        bundle.setAttribute(AbstractButtonPropertyBundle.SELECTED_ICON, "/dev/javai18n/swing/test/MN_Flag.jpg");
