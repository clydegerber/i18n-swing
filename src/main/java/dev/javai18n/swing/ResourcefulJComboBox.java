...
public class ResourcefulJComboBox<E> extends JComboBox<E> implements Resourceful, LocaleEventListener
{
     ...
     * @param resource A Resource containing a JComboBoxPropertyBundle that holds the localized values for the
     *                 JComboBox
     * @return A ResourcefulJComboBox with updated Locale-specific values that is registered to listen to LocaleEvents
     *         generated from the specified Resource's source.
     */
    public static ResourcefulJComboBox<String> create(Resource resource)
    {
        ResourcefulJComboBox<String> box = new ResourcefulJComboBox<>(resource);
        box.initialize();
        return box;
    }
     ...
     *                 JComboBox
     */
    protected ResourcefulJComboBox(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        try
        {
            JComboBoxPropertyBundle props = (JComboBoxPropertyBundle) getResource().getObject();
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.combo.box", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JComboBox.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JComboBox.
     */
    @Override
