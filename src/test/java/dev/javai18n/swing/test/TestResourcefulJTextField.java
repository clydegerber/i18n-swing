...
/**
 * Unit tests for ResourcefulJTextField.
 */
public class TestResourcefulJTextField
{
    ...
    public void testLocaleChange() throws InterruptedException, InvocationTargetException
    {
        ...
        assertEquals("TestTextField nom", textField.getName());
        assertEquals("Info-bulle champ de texte test", textField.getToolTipText());
    }
}
