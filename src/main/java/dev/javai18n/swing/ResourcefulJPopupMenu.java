...
/**
 * A JPopupMenu that supports localizing the name, tool tip, font, accessible name and accessible
 * description, completing the menu component family alongside {@link ResourcefulJMenuBar},
 * {@link ResourcefulJMenu}, and {@link ResourcefulJMenuItem}.
 *
 * <p>Menu items added to a {@code ResourcefulJPopupMenu} should themselves be {@code Resourceful}
 * instances so that the entire popup participates in locale change events.</p>
 */
public class ResourcefulJPopupMenu extends JPopupMenu implements Resourceful, LocaleEventListener
{
     ...
     * @return A ResourcefulJPopupMenu registered to listen to LocaleEvents from the resource's source.
     */
    public static ResourcefulJPopupMenu create(Resource resource)
    {
        ResourcefulJPopupMenu menu = new ResourcefulJPopupMenu(resource);
        menu.initialize();
        return menu;
    }
     ...
     */
    protected ResourcefulJPopupMenu(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.popup.menu", ex);
        }
    }
