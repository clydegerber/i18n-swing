...
/**
 * Unit tests for ResourcefulJCheckBox.
 */
public class TestResourcefulJCheckBox
{
    ...
    public void testLocaleChange()
    {
        ...
        assertEquals("Case Test", checkBox.getText());
        assertEquals("Info-bulle case test", checkBox.getToolTipText());
    }
}
