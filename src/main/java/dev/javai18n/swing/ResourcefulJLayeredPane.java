 ...
 */
public class ResourcefulJLayeredPane extends JLayeredPane implements Resourceful, LocaleEventListener
{
     ...
     *                 JLayeredPane.
     * @return A ResourcefulJLayeredPane with updated Locale-specific values that is registered to listen to
     *         LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulJLayeredPane create(Resource resource)
    {
        ResourcefulJLayeredPane layeredPane = new ResourcefulJLayeredPane(resource);
        layeredPane.initialize();
        return layeredPane;
    }
     ...
     *                 JLayeredPane.
     */
    protected ResourcefulJLayeredPane(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.layered.pane", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JLayeredPane.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JLayeredPane.
     */
    @Override
