...
/**
 * Unit tests for ResourcefulJToolBar.
 */
public class TestResourcefulJToolBar
{
    ...
    public void testLocaleChange() throws InterruptedException, InvocationTargetException
    {
        ...
        assertEquals("TestToolBar nom", toolBar.getName());
        assertEquals("Info-bulle barre d'outils test", toolBar.getToolTipText());
    }
}
