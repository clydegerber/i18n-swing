...
/**
 * A JMenuItem that supports localizing the name, tool tip, font, text, mnemonic, accessible name, accessible
 * description and icons (normal, pressed, selected, disabled, disabled selected, rollover and rollover selected).
 */
public class ResourcefulJMenuItem extends JMenuItem implements Resourceful, LocaleEventListener
{
     ...
     *                 JMenuItem
     * @return A ResourcefulJMenuItem with updated Locale-specific values that is registered to listen to LocaleEvents
     *         generated from the specified Resource's source.
     */
    public static ResourcefulJMenuItem create(Resource resource)
    {
        ResourcefulJMenuItem menuItem = new ResourcefulJMenuItem(resource);
        menuItem.initialize();
        return menuItem;
    }
     ...
     *                 JMenuItem
     */
    protected ResourcefulJMenuItem(Resource resource)
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            SWING_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.menu.item", ex);
        }
    }
     ...
     * @return the Resource holding Locale specific values for the JMenuItem.
     */
    @Override
     ...
     * @param resource the Resource holding Locale specific values for the JMenuItem.
     */
    @Override
     ...
     * Call this when the component is being permanently discarded (e.g. removed from a menu
     * that will be rebuilt) so that it does not accumulate in the source's listener list.
     */
    public void dispose()
    {
        delegate.dispose();
